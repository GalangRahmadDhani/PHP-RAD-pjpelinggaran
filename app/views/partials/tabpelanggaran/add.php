                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <input id="ctrl-siswa_id"  value="<?php  echo $this->set_field_value('siswa_id',""); ?>" type="text" placeholder="Enter Siswa Id"  required="" name="siswa_id"  class="form-control " />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-jpelanggaran_id"  value="<?php  echo $this->set_field_value('jpelanggaran_id',""); ?>" type="text" placeholder="Enter Jpelanggaran Id"  required="" name="jpelanggaran_id"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
