 ...
 * @category  Controller
 */
class TabguruController extends SecureController{
	...
	function add($formdata = null){
		...
		$this->render_view("tabguru/add.php");
	}
	/**
	...
	function edit($rec_id = null, $formdata = null){
		...
		$page_title = $this->view->page_title = "Edit  Tabguru";
		if(!$data){
			$this->set_page_error();
		}
		return $this->render_view("tabguru/edit.php", $data);
	}
	/**
     * Update single field
	 * @param $rec_id (select record by table primary key)
