...
class TabsiswaapiController extends SecureController{
	...
	function indexapi($fieldname = null , $fieldvalue = null){
		...
		$page_title = $this->view->page_title = "Tabsiswa";
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("nama", "nis", "jenkel", "kelas_id", "jurusan_id", "ortu_id", "guru_id", "school_id"); // {{ edit_1 }} - Tambahkan school_id
