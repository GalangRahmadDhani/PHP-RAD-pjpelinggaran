 ...
 * @category  Controller
 */
class TabjurusanController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				tabjurusan.nama LIKE ? OR 
				tabjurusan.date_created LIKE ? OR 
				tabjurusan.date_updated LIKE ?
			)";
			$search_params = array(
				"%$text%","%$text%","%$text%","%$text%"
			);
			...
			$this->view->search_template = "tabjurusan/search.php";
		}
		...
		$page_title = $this->view->page_title = "Program Jurusan";
		$this->view->report_filename = date('Y-m-d') . '-' . $page_title;
		$this->view->report_title = $page_title;
		$this->view->report_layout = "report_layout.php";
		$this->view->report_paper_size = "A4";
		$this->view->report_orientation = "portrait";
		$this->render_view("tabjurusan/list.php", $data); //render the full page
	}
	/**
     * View record detail 
	...
	function add($formdata = null){
		if($formdata){
			...
			if($this->validated()){
				...
				if($rec_id){
					...
					return	$this->redirect("tabjurusan");
				}
				else{
					$this->set_page_error();
				}
		...
		$page_title = $this->view->page_title = "Add New Tabjurusan";
		$this->render_view("tabjurusan/add.php");
	}
	/**
	...
	function edit($rec_id = null, $formdata = null){
		...
		$page_title = $this->view->page_title = "Edit  Tabjurusan";
		if(!$data){
			$this->set_page_error();
		}
		return $this->render_view("tabjurusan/edit.php", $data);
	}
	/**
     * Update single field
	 * @param $rec_id (select record by table primary key)
